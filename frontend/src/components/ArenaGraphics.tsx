    ...
    <div className="relative w-24 h-24 sm:w-28 sm:h-28 mx-auto flex items-center justify-center my-1">
      ...
      <svg viewBox="0 0 160 160" className="w-full h-full drop-shadow-[0_8px_16px_rgba(139,92,246,0.5)]">
        ...
        <g transform="rotate(-45 80 80)">
          ...
          {/* Center Groove */}
          <line x1="80" y1="18" x2="80" y2="95" stroke="#312e81" strokeWidth="1.5" />
          {/* Crossguard */}
          <rect x="62" y="98" width="36" height="8" rx="3" fill="url(#goldHilt)" stroke="#713f12" strokeWidth="1" />
          <circle cx="80" cy="102" r="3.5" fill="#ec4899" />
          {/* Grip */}
          <rect x="76" y="106" width="8" height="22" rx="2" fill="#78350f" stroke="#451a03" strokeWidth="1" />
          <line x1="76" y1="112" x2="84" y2="112" stroke="#b45309" strokeWidth="1" />
          <line x1="76" y1="118" x2="84" y2="118" stroke="#b45309" strokeWidth="1" />
          <line x1="76" y1="124" x2="84" y2="124" stroke="#b45309" strokeWidth="1" />
          {/* Pommel */}
        ...
        <g transform="rotate(45 80 80)">
          ...
          <line x1="76" y1="124" x2="84" y2="124" stroke="#b45309" strokeWidth="1" />
          {/* Pommel */}
          <circle cx="80" cy="133" r="6.5" fill="url(#goldHilt)" stroke="#713f12" strokeWidth="1" />
  ...
  return (
    <div className="relative w-24 h-24 sm:w-28 sm:h-28 mx-auto flex items-center justify-center my-1">
      ...
      <svg viewBox="0 0 160 160" className="w-full h-full drop-shadow-[0_8px_16px_rgba(244,63,94,0.5)]">
        ...
        <circle cx="80" cy="80" r="58" fill="none" stroke="#f43f5e" strokeWidth="2" strokeDasharray="6 3" opacity="0.4" />
        <line x1="80" y1="28" x2="80" y2="36" stroke="#f43f5e" strokeWidth="3" />
        <line x1="80" y1="124" x2="80" y2="132" stroke="#f43f5e" strokeWidth="3" />
        <line x1="28" y1="80" x2="36" y2="80" stroke="#f43f5e" strokeWidth="3" />
        <line x1="124" y1="80" x2="132" y2="80" stroke="#f43f5e" strokeWidth="3" />

        {/* Top/Bottom Wooden Plates */}
        <rect x="42" y="24" width="76" height="10" rx="4" fill="url(#glassFrame)" stroke="#451a03" strokeWidth="1.5" />
        <rect x="42" y="126" width="76" height="10" rx="4" fill="url(#glassFrame)" stroke="#451a03" strokeWidth="1.5" />
        ...
        {/* Trickling Stream */}
        <line x1="80" y1="76" x2="80" y2="108" stroke="#fef08a" strokeWidth="3" strokeLinecap="round" />
        ...
        <path d="M106 34 Q122 22 130 14" fill="none" stroke="#e2e8f0" strokeWidth="3" strokeLinecap="round" />
        {/* Spark Blast */}
  ...
  return (
    <div className="relative w-24 h-24 sm:w-28 sm:h-28 mx-auto flex items-center justify-center my-1">
      ...
      <svg viewBox="0 0 160 160" className="w-full h-full drop-shadow-[0_8px_16px_rgba(6,182,212,0.45)]">
        ...
        <circle cx="80" cy="80" r="48" fill="none" stroke="#38bdf8" strokeWidth="2" strokeDasharray="4 4" opacity="0.4" />
        ...
        <g transform="translate(18, 48) rotate(-14 40 40)">
          ...
          />
          <rect x="10" y="44" width="56" height="8" rx="2" fill="#78350f" stroke="#b45309" strokeWidth="1" />
          <circle cx="38" cy="24" r="3.5" fill="#ef4444" stroke="#ffffff" strokeWidth="1" />
        ...
        <g transform="translate(74, 48) rotate(14 40 40)">
          <polygon
            ...
            strokeLinejoin="round"
          />
          <rect x="10" y="44" width="56" height="8" rx="2" fill="#1e3a8a" stroke="#60a5fa" strokeWidth="1" />
          <circle cx="38" cy="24" r="3.5" fill="#38bdf8" stroke="#ffffff" strokeWidth="1" />
  ...
  return (
    <div className="relative w-24 h-24 sm:w-28 sm:h-28 mx-auto flex items-center justify-center my-1">
      ...
      <svg viewBox="0 0 160 160" className="w-full h-full drop-shadow-[0_8px_16px_rgba(16,185,129,0.45)]">
        ...
        {/* Antennas / Ears */}
        {/* Left Ear */}
        <rect x="22" y="66" width="10" height="28" rx="5" fill="url(#earGrad)" stroke="#881337" strokeWidth="1.5" />
        <line x1="27" y1="46" x2="27" y2="66" stroke="#94a3b8" strokeWidth="3" />
        <circle cx="27" cy="44" r="5.5" fill="#f43f5e" />
        
        {/* Right Ear */}
        <rect x="128" y="66" width="10" height="28" rx="5" fill="url(#earGrad)" stroke="#881337" strokeWidth="1.5" />
        <line x1="133" y1="46" x2="133" y2="66" stroke="#94a3b8" strokeWidth="3" />
        <circle cx="133" cy="44" r="5.5" fill="#f43f5e" />

        {/* Top Antenna Cap */}
        <rect x="75" y="24" width="10" height="8" rx="3" fill="#f59e0b" stroke="#78350f" strokeWidth="1" />
        <line x1="80" y1="24" x2="80" y2="14" stroke="#94a3b8" strokeWidth="3" />
        <circle cx="80" cy="12" r="5" fill="#38bdf8" />

        {/* Robot Head Body */}
        <rect x="30" y="32" width="100" height="96" rx="28" fill="url(#robotHead)" stroke="#cbd5e1" strokeWidth="3" />

        {/* Visor Screen */}
        <rect x="42" y="52" width="76" height="46" rx="14" fill="url(#visorGrad)" stroke="#0f172a" strokeWidth="2" />
        ...
        <path d="M68 85 Q80 92 92 85" fill="none" stroke="#38bdf8" strokeWidth="3" strokeLinecap="round" />
